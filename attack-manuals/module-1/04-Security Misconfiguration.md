...
```
https://appazdazvistoga.blob.core.windows.net/prod-appazdazvi-storage-container/webfiles/build/favicon/Logo.png
```
...
```
https://appazdazvistoga.blob.core.windows.net/dev-appazdazvi-storage-container/webfiles/build/favicon/Logo.png
```
