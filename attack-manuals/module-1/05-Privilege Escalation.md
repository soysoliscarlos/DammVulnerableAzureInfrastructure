...
**Note:** If your resource group has a different name, make sure to replace "azuredazvi_app" with the actual name of your resource group to ensure that the commands are executed on the correct resource group.
...
```
az automation runbook list --automation-account-name <Automation-account-name> -g azuredazvi_app 
```

**Note:** Substitute the name of the automation account with the name of the automation account obtained by listing and matching the principal ID of the resource and also if your resource group has a different name, make sure to replace "azuredazvi_app" with the actual name of your resource group to ensure that the commands are executed on the correct resource group.
...
**Note:** It may take some time to switch from "Contributor" to "Owner" by using the Runbook. If your resource group has a different name, make sure to replace "azuredazvi_app" with the actual name of your resource group
